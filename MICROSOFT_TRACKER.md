...
| [ ]       | P1       | #112368 | [Bug]: Content created with non-unique file name causes msteams to show wrong file                                                                          | `bug` `regression` `clawsweeper-recovery-stuck`                                                                                                                      |          |
...
| [ ]       | P0       | #94940  | feat(googlechat): support Application Default Credentials for outbound auth                                           | XL   |              |
...
| [ ]       | P1       | #112078 | feat: add NVIDIA Nemotron Speech ASR and TTS                                                                          | L    |              |
...
| [ ]       | P1       | #98259  | fix(openai): enable prompt cache keys for Azure                                | S    |          |
...
| MS Teams (channel plugin) | pr    | P0       | #94940  | feat(googlechat): support Application Default Credentials for outbound auth                                                        |
