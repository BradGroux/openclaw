...
>
> **Last updated:** 2026-08-02 (post-purge audit: refreshed from currently open GitHub issues/PRs and rebuilt from PR #49126 format)
...
| ------------------------- | ------ | ------ | ------- | ------ | --------- |
| MS Teams (channel plugin) | 11     | 38     | 49      | 0      | 49        |
| Windows platform          | 45     | 21     | 66      | 0      | 66        |
| WSL                       | 1      | 0      | 1       | 0      | 1         |
| Azure                     | 10     | 9      | 19      | 0      | 19        |
| SharePoint / M365         | 0      | 0      | 0       | 0      | 0         |
| **Total**                 | **67** | **68** | **135** | **0**  | **135**   |
...
| [ ]       | P2       | #117935 | fix(ci): unblock full release validation                                                   | S    | @vincentkoc     |
| [ ]       | P2       | #116647 | fix(channels): preserve bundled plugin delivery and provider contracts                     | M    |                 |
| [ ]       | P2       | #116543 | fix(msteams): page channel thread replies                                                  | M    |                 |
...
| Resolved? | Priority | #       | Title                                                                                                                                                                                   | Labels                                                                                                                                                                                  | Assignee    |
| --------- | -------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| [ ]       | P0       | #116240 | [Bug]: Unix process-tree kill leaves orphan grandchildren when detached:false (Windows taskkill /T has no Unix equivalent)                                                              | `P1` `clawsweeper:no-new-fix-pr` `clawsweeper:needs-maintainer-review` `clawsweeper:needs-product-decision` `clawsweeper:needs-security-review` `clawsweeper:source-repro` +3           |             |
...
| [ ]       | P2       | #117644 | [Bug]: Agent emits Unix commands (head, tilde expansion) in PowerShell on Windows - broader than #10868                                                                                 | `P2` `clawsweeper:no-new-fix-pr` `clawsweeper:source-repro` `clawsweeper:linked-pr-open` `issue-rating: 🦞 diamond lobster` `impact:other`                                              |             |
...
| [ ]       | P2       | #117683 | fix(agents): add PowerShell-compatible command guidance for Windows                 | XS   |             |
...
| [ ]       | P1       | #117593 | [Feature]: Improve Model Override Safety, Auditing, and Centralized Management                      | `enhancement` `P2` `clawsweeper:no-new-fix-pr` `clawsweeper:needs-maintainer-review` `clawsweeper:needs-product-decision` `impact:auth-provider` +1                    |          |
