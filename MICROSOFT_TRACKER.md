...
>
> **Last updated:** 2026-07-28 (post-purge audit: refreshed from currently open GitHub issues/PRs and rebuilt from PR #49126 format)
...
| ------------------------- | ------ | ------ | ------- | ------ | --------- |
| MS Teams (channel plugin) | 16     | 43     | 59      | 0      | 59        |
| Windows platform          | 51     | 21     | 72      | 0      | 72        |
| WSL                       | 1      | 0      | 1       | 0      | 1         |
| Azure                     | 11     | 6      | 17      | 0      | 17        |
| SharePoint / M365         | 0      | 0      | 0       | 0      | 0         |
| **Total**                 | **79** | **70** | **149** | **0**  | **149**   |
...
| [ ]       | P1       | #112078 | feat: add NVIDIA Nemotron Speech ASR and TTS                                                                          | L    | @jacobtomlinson |
...
| [ ]       | P1       | #113436 | [Bug]: [Bug] Windows Companion fails to execute commands via mxc (wxc-exec exitCode=1 / 0xC0000005)                                                                                     | `bug` `bug:crash` `P1` `impact:other`                                                                                                                                            |             |
...
| [ ]       | P2       | #7057  | Flaky tests on Windows/WSL: timeouts and ENOENT in pi-tools workspace-paths & safe-bins                                            | `enhancement` `P3` `clawsweeper:no-new-fix-pr` `clawsweeper:needs-maintainer-review` `clawsweeper:linked-pr-open` `clawsweeper:needs-info` +2                                    |          |
...
| Windows platform          | issue | P1       | #113436 | [Bug]: [Bug] Windows Companion fails to execute commands via mxc (wxc-exec exitCode=1 / 0xC0000005)                                                                                     |
