...
>
> **Last updated:** 2026-07-31 (post-purge audit: refreshed from currently open GitHub issues/PRs and rebuilt from PR #49126 format)
...
| ------------------------- | ------ | ------ | ------- | ------ | --------- |
| MS Teams (channel plugin) | 14     | 39     | 53      | 0      | 53        |
| Windows platform          | 47     | 21     | 68      | 0      | 68        |
| WSL                       | 1      | 0      | 1       | 0      | 1         |
| Azure                     | 9      | 8      | 17      | 0      | 17        |
| SharePoint / M365         | 0      | 0      | 0       | 0      | 0         |
| **Total**                 | **71** | **68** | **139** | **0**  | **139**   |
...
| [ ]       | P2       | #116397 | [Bug]: MS Teams channel thread posts identical answer twice after message-tool delivery                                                                                                             | `P1` `clawsweeper:no-new-fix-pr` `clawsweeper:linked-pr-open` `clawsweeper:needs-live-repro` `impact:message-loss` `issue-rating: 🐚 platinum hermit`               |           |
...
| [ ]       | P2       | #116398 | :bug: fix(msteams): duplicate final answers in Teams channel threads                       | M    |                 |
...
| [ ]       | P1       | #112504 | [Bug]: clawrent channel sessions fail to persist on EVERY write (Windows, temp-file+rename over open handle) — drops replies                                                            | `bug` `bug:behavior` `clawsweeper-recovery-stuck`                                                                                                                                       |             |
...
| [ ]       | P2       | #111595 | [Bug]: Equivalent Windows cwd spellings split catalog project groups                                                                                                                    | `P2` `clawsweeper:no-new-fix-pr` `clawsweeper:linked-pr-open` `issue-rating: 🦪 silver shellfish` `impact:ux-friction`                                                                  |             |
...
| [ ]       | P2       | #116793 | refactor(agents): centralize immutable execution attribution                   | M    |             |
...
| Windows platform          | pr    | P2       | #69059  | fix: retry sqlite-vec load without .dll suffix on Windows                     |
